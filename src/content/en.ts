...
export const en: SiteContent = siteContentSchema.parse({
  ...
  projects: [
    ...
    },
    {
      id: 'haccp',
      name: 'HACCP Platform',
      tagline: 'Full-stack food-safety management with an AI consultant',
      description:
        'A complete HACCP management system — companies, manuals, scheduled controls, inspections, training — with a virtual consultant that answers by citing evidence from the company\u2019s own manuals (RAG over parsed documents).',
      highlights: [
        '15+ domain models in Prisma over PostgreSQL, JWT auth',
        'Document pipeline: PDF/DOCX parsing, OCR fallback, chunking for retrieval',
        'Local LLM integration via Ollama; PDF report generation and signature capture',
      ],
      stack: [
        'NestJS 11',
        'Prisma 7 + PostgreSQL',
