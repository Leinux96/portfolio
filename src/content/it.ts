...
export const it: SiteContent = siteContentSchema.parse({
  ...
  projects: [
    ...
    },
    {
      ...
      repo: 'https://github.com/Leinux96/addiction',
    },
    {
      id: 'haccp',
      name: 'Piattaforma HACCP',
      tagline: 'Gestione sicurezza alimentare full-stack con consulente AI',
      description:
        'Un sistema completo di gestione HACCP — aziende, manuali, controlli programmati, ispezioni, formazione — con un consulente virtuale che risponde citando le evidenze dai manuali dell\u2019azienda stessa (RAG su documenti parsati).',
      highlights: [
        '15+ modelli di dominio in Prisma su PostgreSQL, auth JWT',
        'Pipeline documentale: parsing PDF/DOCX, fallback OCR, chunking per il retrieval',
        'Integrazione LLM locale via Ollama; generazione report PDF e firma digitale',
      ],
      stack: [
        'NestJS 11',
        'Prisma 7 + PostgreSQL',
      ...
      repo: 'https://github.com/Leinux96/haccp',
    },
  ],
  skillAxes: [
    {
